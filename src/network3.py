...
from pytensor.tensor import softmax
from pytensor.tensor import shared_randomstreams
from pytensor.tensor.signal import downsample
from pytensor.tensor import sigmoid
...
if GPU:
    ...
    print (f"Running with a CPU.  If this is not desired, then the modify \nnetwork3.py to set\nthe GPU flag to True.")
